...
<p align="center">
  <img src="https://github.com/Noelia-vera/TFM_Industriales_UC3M/raw/main/imagenes/Frame%2019.png" alt="Frame 19" width="400"/>
</p>
...
* **Mobile base:**: This platform is the RB-1 model manufactured by the company Robotnik, with dimensions of 50 cm in diameter, two motorized wheels, and three support casters. In this way, the robot can move forward, backward, and rotate on itself, although it cannot move laterally.

* **Dual-arm System:** Due to the need to equip the robot with collaborative arms, the UR3 model from Universal Robots was selected for both arms. Each arm has a total length of 50 cm and a maximum payload capacity of 3 kg. Each arm consists of 6 degrees of freedom (DoF) with a range of motion of ±360$^{\circ}$, except for the end-effector, which allows for more than one full rotation.
...
<p align="center">
  <img src="https://github.com/Noelia-vera/TFM_Industriales_UC3M/raw/main/imagenes/Frame 1.png" alt="Simulador Coppelia2" width="500"/>
</p>
...
<p align="center">
  <img src="https://github.com/Noelia-vera/TFM_Industriales_UC3M/raw/main/imagenes/Frame 18.png" alt="Simulador Coppelia28" width="500"/>
</p>
